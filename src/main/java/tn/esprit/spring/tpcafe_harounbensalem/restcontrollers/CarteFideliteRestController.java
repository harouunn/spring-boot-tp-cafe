...
import tn.esprit.spring.tpcafe_harounbensalem.services.CarteFidelite.ICarteFideliteService;
...
public class CarteFideliteRestController {
    ...
    public List<CarteFideliteResponse> findPointsBetweenAfterDate(
    ...
    @GetMapping("/client")
    public List<CarteFideliteResponse> findByClientNomPrenom(
