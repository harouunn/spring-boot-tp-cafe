package tn.esprit.spring.tpcafe_harounbensalem.services.DetailCommande;
...
import tn.esprit.spring.tpcafe_harounbensalem.entities.Detail_Commande;
import tn.esprit.spring.tpcafe_harounbensalem.mapper.DetailCommandeMapper;
...
import tn.esprit.spring.tpcafe_harounbensalem.repositories.DetailCommandeRepository;
...
public class DetailCommandeService implements IDetailCommandeService {
    ...
    public DetailCommandeResponse addDetailCommande(DetailCommandeRequest request) {
        ...
        Detail_Commande detailCommande = detailCommandeMapper.toEntity(request);

        detailCommande.setArticle(article);
        detailCommande.setCommande(commande);

        Detail_Commande saved = detailCommandeRepository.save(detailCommande);
    ...
    public DetailCommandeResponse selectDetailCommandeById(long id) {
        Detail_Commande detail = detailCommandeRepository.findById(id)
    ...
    public DetailCommandeResponse updateDetailCommande(long id, DetailCommandeRequest request) {
        ...
        Detail_Commande updated = detailCommandeRepository.save(detail);
