package tn.esprit.spring.tpcafe_harounbensalem.services.Promotion;
...
import tn.esprit.spring.tpcafe_harounbensalem.mapper.PromotionMapper;
...
public class PromotionService implements IPromotionService {
    ...
    public void findPromotionsDuMois() {
        List<PromotionResponse> promotions = findActiveAt(LocalDate.now());
        System.out.println("===== Promotions du mois =====");
